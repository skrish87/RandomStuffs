...
public class PhotosActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        int aid = i.getIntExtra("AlbumId", 0);
        title = i.getStringExtra("AlbumTitle");
        getSupportActionBar().setTitle(title);
        try {
            new json().execute("http://kishore.cinemazz.com/json/Photos.aspx?AlbumId=" + aid);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    class json extends AsyncTask<String, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            mProgressDialog = new ProgressDialog(PhotosActivity.this);
        ...
        protected void onPostExecute(Void value) {
            ...
            adapter = new ImageAdapter(PhotosActivity.this, arraylist);
            ...
            gv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                    ...
                    Intent n = new Intent(getApplicationContext(), PhotoActivity.class);
                    n.putExtra("PhotoUrl", a.url);
                    n.putExtra("PhotoTitle", a.title);
                    startActivity(n);
                }
            });
