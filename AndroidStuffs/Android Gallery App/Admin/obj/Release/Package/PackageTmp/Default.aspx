      ...
      <div class="header">
        <nav>
          <ul class="nav nav-pills pull-right">
            <li role="presentation"><a href="Default.aspx">Albums</a></li>
            <li role="presentation"><a href="Photos.aspx">Photos</a></li>
          </ul>
        </nav>
          ...
          <asp:GridView ID="gv" runat="server" CssClass="table table-bordered" GridLines="None" AutoGenerateColumns="false">
              <Columns>
                  ...
                  <asp:TemplateField ItemStyle-Width="130px">
                      <ItemTemplate>
                          <asp:Button ID="Edit" runat="server" Text="Edit" CommandArgument='<%# Eval("Id")%>' OnClick="Edit_Click" CommandName="<%# Eval("Title")%>" CssClass="btn btn-default btn-sm" />
                          <asp:Button ID="Delete" runat="server" Text="Delete" CommandArgument='<%# Eval("Id")%>' OnClick="Delete_Click" CssClass="btn btn-default btn-sm" />
                      </ItemTemplate>
                  </asp:TemplateField>
              </Columns>
          </asp:GridView>
